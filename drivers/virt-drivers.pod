...
This tool best supports Linux at present, and only has outline support
for Windows.  Windows support will be enhanced in a future release of
guestfs-tools.
...
guest.  If known, this may contain information about what OS kernels
